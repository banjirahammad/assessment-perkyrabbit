                ...
                <div class="col-lg-8 offset-lg-2">
                    <form class="row g-3" method="POST" action="{{ route('employee.store') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" placeholder="Enter your name" value="{{ old('name') }}" class="form-control" id="name">
                            @error('name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" placeholder="Enter your email" name="email" value="{{ old('email') }}" class="form-control" id="email">
                            @error('email')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" placeholder="Enter your phone number" name="phone" value="{{ old('phone') }}" class="form-control" id="phone">
                            @error('phone')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary text-primary text-light bg-primary" >Add Employee</button>
                        </div>
                    </form>
                </div>
            </div>
